...
def ragas_score(pergunta, resposta, contextos, ground_truth,):
    """
...
#
#
#ef eval_sample(Pergunta, ground_truth, metrics):
#   """
#   Evaluates the response generated for a given question
#   Retrieves the response and contexts
#   Evaluates all metrics for it
...
#
#ef evaluate_dataframe(df, metrics):
#   """
...
#er_res = pd.read_csv("ragastest/Per_res melhorado.csv", delimiter=",")
#esult = eval_sample(per_res["PerguntaCompleta"][2], per_res["Resposta"][2],metrics = metrics)
#rint(result)
#
#
